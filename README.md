...
- [io.github.aarifmms.keyblind](https://github.com/aarifmms/keyblind) - Encrypted secrets vault with MCP for AI agents. Secrets resolved at runtime, never leaked to LLM conversations.
